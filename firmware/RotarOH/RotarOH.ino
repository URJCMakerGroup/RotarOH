...
int raton1 = 0;    // Variable que define si la rata ha caido (1: rata caida)
int raton2 = 0;
int raton3 = 0;
int raton4 = 0;
int raton5 = 0;
...
int vmax = 77;        // Velocidad máxima del sistema
...
int Tamax = 20;       // Tasa de aceleración máxima del sistema
...
{ 
  ...
  if (Modo == 0) //Falta el resto de carriles
  {
    ...
    if (raton1 == 0)  //Display velocidad y tiempo de cada carril
    {
      if (segundos < 10)      
      {
        lcd.setCursor(2,0);
    ...
    if (raton1==1 and raton2==1 and raton3==1 and raton4==1 and raton5==1 and raton6==1)
    {
      estado = 5; 
      segundos = 0; 
    }
  ...
  else if (Modo == 1)
  {
    ...
    if (raton3 == 0)  //Display velocidad y tiempo de cada carril
    {
      if (segundos < 10)      
      {
        lcd.setCursor(8,0);
    ...
    if (raton4 == 0)  //Display velocidad y tiempo de cada carril
    {
      if (segundos < 10)      
      {
        lcd.setCursor(11, 2);
    ...
    if (raton5 == 0)  //Display velocidad y tiempo de cada carril
    {
      if (segundos < 10)      
      {
        lcd.setCursor(14,0);
    ...
    if (raton6 == 0)  //Display velocidad y tiempo de cada carril
    {
      if (segundos < 10)      
      {
        lcd.setCursor(17,2);
